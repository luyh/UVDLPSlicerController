...
namespace UV_DLP_3D_Printer._3DEngine.CSG
{
    ...
    public class CSG
    {
        ...
        public static Object3d Subtract(Object3d obj1, Object3d obj2)
        {
            List<csgjs_polygon> a = ConvertTo(obj1);
            List<csgjs_polygon> b = ConvertTo(obj2);
            csgjs_csgnode A = new csgjs_csgnode(a);
        ...
        public static Object3d Intersect(Object3d obj1, Object3d obj2)
        {
            List<csgjs_polygon> a = ConvertTo(obj1);
            List<csgjs_polygon> b = ConvertTo(obj2);
            csgjs_csgnode A = new csgjs_csgnode(a);
        ...
        private static List<csgjs_polygon> ConvertTo(Object3d obj) 
        {
        ...
        private static Object3d ConvertFrom(List<csgjs_polygon> lstply) 
        {
